...
void PointCloudViewer::reset()
{
	...
	save_folder = ros::package::getPath("ar_viewer")+"/save/";
...
void PointCloudViewer::addFrameMsg(ar_viewer::keyframeMsgConstPtr msg)
{
	meddleMutex.lock();
...
void PointCloudViewer::addGraphMsg(ar_viewer::keyframeGraphMsgConstPtr msg)
{
	meddleMutex.lock();
